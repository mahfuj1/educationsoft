                            ...
                            <div class="form-row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input readonly="" placeholder="" type="text" name="program_duration" value="" class="form-control">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="" readonly="" name="credit" value="" class="form-control">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="" name="semester_duration" readonly="" value="" class="form-control">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input readonly="" placeholder="000.00" type="text" name="per-credit-fee" value="" class="form-control">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" readonly="" placeholder="000.00"  name="lab-fee" value="" class="form-control">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" readonly="" placeholder="000.00" name="library-fee" value="" class="form-control">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="registration-fee" readonly="" placeholder="000.00" value="" class="form-control"> 
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-row">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label class="control-label">Total Tuition Fee : 00.00</label> BDT


                                                    <br/>
                                                    <label>Total Registration Fee: </label> 00.00 BDT

                                                    <br>
                                                    <label>Lab Fee: </label>   00.00 BDT
